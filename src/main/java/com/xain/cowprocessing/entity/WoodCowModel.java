...
@OnlyIn(Dist.CLIENT)
public class WoodCowModel<T extends Entity> extends QuadrupedModel<T> {

    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(CowProcessing.MODID, "woodcow"), "layer");

    public WoodCowModel(ModelPart part) {
